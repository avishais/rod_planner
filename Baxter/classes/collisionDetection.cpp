...
// Returns 0 if no collision
{
	...
	PQP_REAL R82[3][3],T82[3][3],RInt[3][3],MInt[3][3],Mrod[3][3],Rrod[3][3];
	...
	PQP_Tolerance(&res[87],Rrod,Trod,&rod,R0,TP,&ped,tolerance);
	PQP_Tolerance(&res[88],Rrod,Trod,&rod,R1,T1,&link1,tolerance);
	PQP_Tolerance(&res[89],Rrod,Trod,&rod,R2,T2_t,&link2,tolerance);
	PQP_Tolerance(&res[90],Rrod,Trod,&rod,R3,T3,&link3,tolerance);
	PQP_Tolerance(&res[91],Rrod,Trod,&rod,R4,T4,&link4,tolerance);
	PQP_Tolerance(&res[92],Rrod,Trod,&rod,R5,T5,&link5,tolerance);
	PQP_Tolerance(&res[93],Rrod,Trod,&rod,R6,T6,&link6,tolerance);
	PQP_Tolerance(&res[94],Rrod,Trod,&rod,R7,T7,&link7,tolerance);
	PQP_Tolerance(&res[95],Rrod,Trod,&rod,R0,T0,&base,tolerance);
	PQP_Tolerance(&res[96],Rrod,Trod,&rod,R12,T12,&link12,tolerance);
	PQP_Tolerance(&res[97],Rrod,Trod,&rod,R22,T2_t2,&link22,tolerance);
	PQP_Tolerance(&res[98],Rrod,Trod,&rod,R32,T32,&link32,tolerance);
	PQP_Tolerance(&res[99],Rrod,Trod,&rod,R42,T42,&link42,tolerance);
	PQP_Tolerance(&res[100],Rrod,Trod,&rod,R52,T52,&link52,tolerance);
	PQP_Tolerance(&res[101],Rrod,Trod,&rod,R62,T62,&link62,tolerance);
	PQP_Tolerance(&res[102],Rrod,Trod,&rod,R72,T72,&link72,tolerance);
	...
	PQP_Tolerance(&res[104],Rrod,Trod,&rod_EE1,REE,TEE,&EE,tolerance);
	PQP_Tolerance(&res[105],Rrod,Trod,&rod_EE2,REE2,TEE2,&EE2,tolerance);
	...
	if(withObs) {
		...
		PQP_Tolerance(&res[114],Rtable,Ttable,&table,Rrod,Trod,&rod,tolerance);
		...
		PQP_Tolerance(&res[123],Rwall,Twall,&wall,Rrod,Trod,&rod,tolerance);
